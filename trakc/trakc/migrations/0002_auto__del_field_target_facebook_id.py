...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Target.facebook_id'
        db.delete_column('trakc_target', 'facebook_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Target.facebook_id'
        raise RuntimeError("Cannot reverse this migration. 'Target.facebook_id' and its values cannot be restored.")
